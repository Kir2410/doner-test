...
Работа по проекту проходила в порядке, приближенному к реальному взаимодействию с заказчиком с помощью сервиса Trello. В роли заказчика выступал куратор курса.
